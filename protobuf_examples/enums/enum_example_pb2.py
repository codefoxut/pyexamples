...
# source: protobuf_examples/enum_example/enum_example.proto
...
EnumMessage = _reflection.GeneratedProtocolMessageType('EnumMessage', (_message.Message,), {
  ...
  '__module__' : 'protobuf_examples.enum_example.enum_example_pb2'
