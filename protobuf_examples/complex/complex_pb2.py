...
# source: protobuf_examples/complex/complex.proto
...
ComplexMessage = _reflection.GeneratedProtocolMessageType('ComplexMessage', (_message.Message,), {
  ...
  '__module__' : 'protobuf_examples.complex.complex_pb2'
