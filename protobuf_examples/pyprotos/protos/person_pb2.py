...
_PERSON.fields_by_name['birthday'].message_type = protos_dot_date__pb2._DATE
_PERSON.fields_by_name['addresses'].message_type = protos_dot_address__pb2._ADDRESS
