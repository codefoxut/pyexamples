...
# source: grpc_examples/bidirectional/bidirectional.proto
...
Message = _reflection.GeneratedProtocolMessageType('Message', (_message.Message,), {
  'DESCRIPTOR' : _MESSAGE,
  '__module__' : 'grpc_examples.bidirectional.bidirectional_pb2'
